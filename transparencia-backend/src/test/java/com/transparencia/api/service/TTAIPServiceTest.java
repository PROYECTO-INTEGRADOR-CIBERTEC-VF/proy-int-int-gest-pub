...
class TTAIPServiceTest {
    ...
    private Apelacion crearApelacionPrimeraCalificacion() {
        ...
        apelacion.setEstado(EstadoApelacion.EN_CALIFICACION_1);
    ...
    void admitirApelacionDebeCambiarEstadoAEnCalificacion2() {
        ...
        when(apelacionService.obtenerApelacionPorId(1L)).thenReturn(Optional.of(apelacion));
        ...
        assertThat(resultado.getEstado()).isEqualTo(EstadoApelacion.EN_CALIFICACION_2.name());
        assertThat(apelacion.getCalificacionPrimera()).isEqualTo(Calificacion.ADMISIBLE);
    ...
    void requerirSubsanacionDebeCambiarEstadoAEnSubsanacion() {
        ...
        assertThat(resultado.getEstado()).isEqualTo(EstadoApelacion.EN_SUBSANACION.name());
        assertThat(apelacion.getCalificacionPrimera()).isEqualTo(Calificacion.INADMISIBLE);
    ...
    void inadmitirApelacionDebeCambiarEstadoAResueltoImprocedente() {
        ...
        assertThat(resultado.getEstado()).isEqualTo(EstadoApelacion.RESUELTO_IMPROCEDENTE.name());
        assertThat(apelacion.getCalificacionPrimera()).isEqualTo(Calificacion.IMPROCEDENTE);
        verify(resolucionService).save(any(Resolucion.class));
        verify(apelacionService).save(apelacion);
    }
}
