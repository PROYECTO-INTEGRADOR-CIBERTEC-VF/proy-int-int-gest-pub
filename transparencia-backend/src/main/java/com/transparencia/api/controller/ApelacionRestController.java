...
public class ApelacionRestController {
    ...
    public ResponseEntity<Apelacion> subsanarApelacion(@PathVariable Long id, @RequestBody Map<String, String> body) {
        ...
        if (body == null || !body.containsKey("fundamentosAdicionales")) {
            return ResponseEntity.badRequest().build();
        }

        String fundamentosAdicionales = body.get("fundamentosAdicionales");

        try {
            Apelacion apelacionActualizada = apelacionService.subsanar(id, fundamentosAdicionales);
